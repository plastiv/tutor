...
public class DownloadTask extends AsyncTask<String, Integer, Long> {
	...
	protected Long doInBackground(String... params) {
		try {
			...
			case R.id.dictionary_menu_url:
				new Downloader(mActivity.getContentResolver()).fromUrl(params[0]);
				break;
			case R.id.dictionary_menu_file:
				new Downloader(mActivity.getContentResolver()).fromFile(params[0]);
				break;
	...
	protected void onPostExecute(Long result) {
		mActivity.showDictionaryList(Dictionary.CONTENT_URI);
